<div class="mx-auto min-h-screen">
    ...
    <!-- Main Title -->
    <div class="mb-6 sm:mb-8 md:mb-5">
    ...
    <section class="mb-8 sm:mb-10 md:mb-12">
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Setting the License</h1>
        ...
        <div class="mb-8 sm:mb-10">
            ...
            <p class="text-gray-700 text-sm sm:text-base mb-4">
                If the developer intends to self-host Editflounder the GPL license and agree to its terms, they can set the <code class="bg-gray-100 px-1.5 py-0.5 rounded font-mono">license_key</code> config option to 'gpl'. Case sensitivity does not matter.
            </p>
        ...
        <div class="mb-8 sm:mb-10">
            ...
            <p class="text-gray-700 text-sm sm:text-base mb-4">
                The Editflo8 commercial license key will have a <code class="bg-gray-100 px-1.5 py-0.5 rounded font-mono">T8LK:</code> prefix.
            </p>
            <p class="text-gray-700 text-sm sm:text-base font-medium mb-2">Example:</p>
            <div class="bg-gray-900 text-gray-100 p-3 sm:p-4 md:p-5 rounded-lg overflow-x-auto">
                <pre class="text-xs sm:text-sm md:text-base font-mono">
        ...
        <div class="mb-8 sm:mb-10">
            ...
            <p class="text-gray-700 text-sm sm:text-base mb-4">
                The Editflo8 commercial license key will have a <code class="bg-gray-100 px-1.5 py-0.5 rounded font-mono">GPL+T8LK:</code> prefix.
            </p>
            <p class="text-gray-700 text-sm sm:text-base font-medium mb-2">Example:</p>
            <div class="bg-gray-900 text-gray-100 p-3 sm:p-4 md:p-5 rounded-lg overflow-x-auto">
                <pre class="text-xs sm:text-sm md:text-base font-mono">
    ...
    <section class="mb-8 sm:mb-10 md:mb-12">
        ...
        <ul class="list-disc pl-4 sm:pl-5 space-y-2 mb-4 sm:mb-5">
            <li class="text-sm sm:text-base text-gray-700 leading-relaxed">
                <span class="font-medium">If hosting Editflostandalone</span>, for example, in a <code class="bg-gray-100 px-1.5 py-0.5 rounded font-mono text-xs sm:text-sm">/public</code> folder, ensure the <code class="bg-gray-100 px-1.5 py-0.5 rounded font-mono text-xs sm:text-sm">licensekeymanager</code> folder is included in the <code class="bg-gray-100 px-1.5 py-0.5 rounded font-mono text-xs sm:text-sm">plugins</code> folder with all of the other plugins. The editor will not function without this.
            </li>
            <li class="text-sm sm:text-base text-gray-700 leading-relaxed">
                <span class="font-medium">If bundling Editfloas part of an application</span> ensure the <code class="bg-gray-100 px-1.5 py-0.5 rounded font-mono text-xs sm:text-sm">licensekeymanager/index.js</code> file is imported, otherwise the editor will not function without this.
            </li>
        </ul>
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <ul class="text-gray-700 text-sm sm:text-base list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-2">
                            ...
                            <li class="leading-relaxed">
                                The <code class="bg-gray-100 px-1 py-0.5 rounded font-mono text-xs sm:text-sm">external_plugins</code> option allows loading the license key manager from any location, useful when bundling is not available or when lazy-loading plugins. For more information, see: <code class="bg-gray-100 px-1 py-0.5 rounded font-mono text-xs sm:text-sm">external_plugins</code> <a href="https://www.Editflo.cloud/docs/Editflo/latest/editor-important-options/#external_plugins" class="text-blue-600 hover:text-blue-800 underline break-words">configuration option</a>.
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                ...
                <div class="space-y-3">
                    <div>
                        <h4 class="text-sm font-medium text-gray-700 mb-1">Console Message</h4>
                        <div class="bg-gray-50 p-3 rounded border border-gray-200 font-mono text-xs">
                            The editor is disabled because the EditfloAPI key could not be validated.
                        </div>
                    </div>
    ...
    <section class="mb-8 md:mb-12">
        ...
        <div class="space-y-6 md:space-y-8">
            ...
            <div id="load-errorself-hosted">
                ...
                <p class="text-gray-700 text-sm sm:text-base">
                    For self-hosted installations, the EditfloCommercial License Key Manager plugin is required for commercial license keys otherwise the editor will be disabled. If it cannot be loaded, see the <a href="https://www.Editflo.cloud/docs/Editflo/latest/license-key/#setting-up-the-commercial-license-key-manager" class="text-blue-600 hover:text-blue-800 underline">Setting up the Commercial License Key Manager</a> section for implementation details.
                </p>
            </div>
