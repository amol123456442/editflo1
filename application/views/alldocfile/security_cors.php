<div class="mx-auto min-h-screen">
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6 mb-8">
        ...
        <p class="text-gray-700 sm:text-base mb-6">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-700 sm:text-base mb-3 font-medium">Type: Function (url: string, resourceType: 'script' | 'stylesheet') => string</p>
            <p class="text-gray-700 sm:text-base mb-3">
            ...
            <p class="text-gray-700 sm:text-base mb-3 font-medium">Possible return values:</p>
            <ul class="list-disc list-inside text-gray-700 sm:text-base mb-3 ml-4">
            ...
            <div class="bg-gray-50 p-4 rounded-lg mb-4">
                <p class="text-gray-700 sm:text-base mb-2 font-medium">Example: Basic configuration</p>
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                <p class="text-gray-700 sm:text-base mb-2 font-medium">Example Script Tag for Editflo Cloud:</p>
                <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-700 sm:text-base mb-3 font-medium">Type: String</p>
            <div class="mb-3 p-3 bg-gray-50 rounded">
                <p class="text-gray-700 sm:text-base text-sm">
                    For a list of valid referrer policies (directives), see: MDN Web Docs - Referrer-Policy
                </p>
            </div>

            <div class="bg-gray-50 p-4 rounded-lg">
                <p class="text-gray-700 sm:text-base mb-2 font-medium">Example: using referrer_policy</p>
                <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                    <span class="text-purple-400">editflo</span><span class="text-gray-300">.</span><span class="text-yellow-300">init</span><span class="text-gray-300">({</span><br>
        ...
        <div class="mb-8">
            ...
            <div class="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-r mb-4">
                <p class="text-yellow-700 sm:text-base">
            ...
            <p class="text-gray-700 sm:text-base mb-3 font-medium">Type: Boolean</p>
            <p class="text-gray-700 sm:text-base mb-3 font-medium">Default value: false</p>
            <p class="text-gray-700 sm:text-base mb-3 font-medium">Possible values: true, false</p>

            <div class="bg-gray-50 p-4 rounded-lg">
                <p class="text-gray-700 sm:text-base mb-2 font-medium">Example: using content_css_cors</p>
                <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-700 sm:text-base mb-3 font-medium">Important:</p>
            <ul class="list-disc list-inside text-gray-700 sm:text-base mb-3 ml-4">
            ...
            <p class="text-gray-700 sm:text-base mb-3 font-medium">Type: Array</p>
            <p class="text-gray-700 sm:text-base mb-3 font-medium">Default value: []</p>

            <div class="bg-gray-50 p-4 rounded-lg">
                <p class="text-gray-700 sm:text-base mb-2 font-medium">Example: editimage_cors_hosts</p>
                <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                    <span class="text-purple-400">editflo</span><span class="text-gray-300">.</span><span class="text-yellow-300">init</span><span class="text-gray-300">({</span><br>
                    <span class="text-gray-300 ml-4"></span><span class="text-blue-400">selector</span><span class="text-gray-300">: </span><span class="text-green-400">'textarea'</span><span class="text-gray-300">, </span><span class="text-green-400">// change this value according to your HTML</span><br>
        ...
        <div class="mb-8">
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                <p class="text-gray-700 sm:text-base mb-2 font-medium">Example: export_cors_hosts</p>
                <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                    <span class="text-purple-400">editflo</span><span class="text-gray-300">.</span><span class="text-yellow-300">init</span><span class="text-gray-300">({</span><br>
                    <span class="text-gray-300 ml-4"></span><span class="text-blue-400">selector</span><span class="text-gray-300">: </span><span class="text-green-400">'textarea'</span><span class="text-gray-300">, </span><span class="text-green-400">// change this value according to your HTML</span><br>
