<main class="mx-auto min-h-screen px-3 sm:px-4 md:px-6 lg:px-8">
    ...
    <header class="text-start">
        <div class="flex items-center mb-3 sm:mb-2md:mb-5">
            <h2 class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800">Editflo for Java Swing Integration</h2>
        </div>
        <p class="text-gray-700 sm:mb-2text-sm sm:text-base text-sm sm:text-base mt-1 sm:mt-2">
        ...
        <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6 mt-3">
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-gray-700 sm:mb-2text-sm sm:text-base text-yellow-700">
    ...
    <section class="bg-white     p-4 sm:p-6 mb-6 sm:mb-8 mt-2">
        ...
        <div class="py-4 sm:py-6 md:py-8">
            <p class="text-gray-700 sm:mb-2text-sm sm:text-base text-sm sm:text-base mb-6">
            ...
            <div class="space-y-4 sm:space-y-6">
                ...
                <div class="flex items-start  rounded-lg p-4 sm:p-6 border-l-4 border-blue-200">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-gray-700 sm:mb-2text-sm sm:text-base text-sm sm:text-base">
                ...
                <div class="flex items-start rounded-lg p-4 sm:p-6 border-l-4 border-blue-200">
                    ...
                    <div class="flex-1 min-w-0">
                        <h3 class="font-semibold text-gray-800 text-sm sm:text-base mb-2">Select Deployment & Create
                            Configuration</h3>
                        <p class="text-gray-700 sm:mb-2text-sm sm:text-base text-sm sm:text-base mb-4">
        ...
        <div class="space-y-6">
            ...
            <div
                ...
                <div class="flex-1">
                    ...
                    <p class="text-gray-700 sm:mb-2text-sm sm:text-base text-base mb-4">
            ...
            <div
                ...
                <div class="flex-1">
                    ...
                    <div
                        class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-700 sm:mb-2text-sm sm:text-base bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-gray-100">
            ...
            <div
                ...
                <div class="relative z-10 flex flex-col sm:flex-row sm:items-center">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-gray-700 sm:mb-2text-sm sm:text-base text-base mb-6">
    ...
    <section class="bg-white rounded-lg border p-6 mb-8">
        ...
        <div class="space-y-8">
            ...
            <div>
                <div class="flex items-center mb-3">
                    <i class="fab fa-github text-gray-700 sm:mb-2text-sm sm:text-base mr-3"></i>
                    <h3 class="text-lg font-medium text-gray-800">GitHub Repository</h3>
                </div>
                <p class="text-gray-700 sm:mb-2text-sm sm:text-base mb-2">
            ...
            <div>
                <div class="flex items-center mb-4">
                    <i class="fas fa-file-archive text-gray-700 sm:mb-2text-sm sm:text-base mr-3"></i>
                    <h3 class="text-lg font-medium text-gray-800">Documentation Package</h3>
                </div>
                <p class="text-gray-700 sm:mb-2text-sm sm:text-base mb-4">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start">
                        ...
                        <div>
                            <p class="text-gray-700  text-sm sm:text-base text-gray-800">readme.txt</p>
                            <p class="text-gray-700  text-sm sm:text-base text-sm">General information about Editflo for Swing integration</p>
                        </div>
                    </li>
                    ...
                    <li class="flex items-start">
                        ...
                        <div>
                            <p class="text-gray-700  text-sm sm:text-base text-gray-800">license.txt</p>
                            <p class="text-gray-700  text-sm sm:text-base text-sm">License details about Editflo for Swing as commercial
                                software</p>
                        </div>
                    </li>
                    ...
                    <li class="flex items-start">
                        ...
                        <div>
                            <p class="text-gray-700 text-sm sm:text-base text-gray-800">release-notes.txt</p>
                            <p class="text-gray-700 text-sm sm:text-base text-sm">Integrations and enhancements implemented in Editflo for
                                Swing</p>
                        </div>
                    </li>
                    ...
                    <li class="flex items-start">
                        ...
                        <div>
                            <p class="text-gray-700 text-sm sm:text-base text-gray-800">change-log.md</p>
                            <p class="text-gray-700 text-sm sm:text-base text-sm">User impacting and major changes for every release</p>
                        </div>
                    </li>
                </ul>
            </div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 sm:mb-2text-sm sm:text-base text-sm">Located in the <code
                    ...
                    <li class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 sm:mb-2text-sm sm:text-base text-sm">Available at <code
