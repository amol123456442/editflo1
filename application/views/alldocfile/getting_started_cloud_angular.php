        ...
        <div class="space-y-3 sm:space-y-4">
            ...
            <div class="flex items-start">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-600 text-xs sm:text-sm mt-1">Create a new Angular project named
                        Editflo-angular-demo.</p>
                    <code
                        class="bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs sm:text-sm mt-1 sm:mt-2 inline-block font-mono">ng new --defaults --skip-git Editflo-angular-demo</code>
                </div>
            </div>
            ...
            <div class="flex items-start">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-600 text-xs sm:text-sm mt-1">Change into the project directory and install the
                        Editflo Angular package.</p>
                    <code
                        class="bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs sm:text-sm mt-1 sm:mt-2 inline-block font-mono">cd Editflo-angular-demo</code>
                    <code
                        class="bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs sm:text-sm mt-1 sm:mt-2 inline-block font-mono ml-2">npm install @Editflo/Editflo-angular</code>
                </div>
            </div>
                        ...
                        <div class="space-y-1">
                            <div class="flex">
                                ...
                                <span class="text-purple-400">import</span> <span class="text-gray-300">{ Component
                                    ...
                                    class="text-green-400">'@angular/core'</span><span class="text-gray-300">;</span>
                            </div>
                            <div class="flex">
                                ...
                                <span class="text-purple-400">import</span> <span class="text-gray-300">{ Editor
                                    ...
                                    class="text-green-400">'@Editflo/Editflo-angular'</span><span
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300">= </span><span
                                    class="text-green-400">'Editflo-angular-demo'</span><span
                                    class="text-gray-300">;</span>
                            </div>
                            <div class="flex">
            ...
            <div class="space-y-2 sm:space-y-3">
                <div class="flex items-start">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <code
                            class="bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs sm:text-sm mt-1 inline-block font-mono">ng build</code>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <code
                            class="bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs sm:text-sm mt-1 inline-block font-mono">ng serve --configuration production</code>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-gray-600 text-xs sm:text-sm">Copy contents of <code
                                class="bg-gray-100 px-1 rounded text-xs">Editflo-angular-demo/dist</code> to web server
                            root.</p>
                    </div>
                </div>
            </div>
