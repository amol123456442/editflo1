<div class="mx-auto min-h-screen px-4">
    ...
    <div class="mb-8">
        ...
        <p class="text-lg text-gray-600">This example includes only non-premium plugins. These plugins are also used in the Full featured demo: Including Premium Plugins.</p>
    </div>
