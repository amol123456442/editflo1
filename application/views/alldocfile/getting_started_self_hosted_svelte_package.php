        ...
        <div class="mb-3 sm:mb-4 md:mb-5">
            <p class="text-gray-600 text-sm sm:text-base mt-1 sm:mt-2 flex items-start">
                ...
                <span class="flex-1 min-w-0">
                    The Official Editflo Saveltecomponent integrates Editflo into Savelteapplications. This procedure
                    creates a basic Savelteapplication and adds a Editflo editor using the Editflo Savelteintegration.
                    <br><br>
                    The basic Savelteapplication is based on the following tutorial:
                    <br><strong>Microsoft .NET SavelteTutorial - Build your first Savelteapp.</strong>
                </span>
            </p>
        </div>
            ...
            <div class="flex flex-col lg:flex-row lg:items-start lg:gap-6 mb-8 lg:mb-10">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-slate-600 text-sm sm:text-base lg:text-lg max-w-3xl leading-relaxed">
                        Choose your preferred development environment to get started with Editflo Savelteintegration
                    </p>
                </div>
            </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-slate-600 text-xs sm:text-sm mt-1 leading-relaxed">
                                        Open Command Palette (Ctrl+Shift+P) → ".NET: New Project" → Select SavelteWeb
                                        App template
                                    </p>
                                </div>
                            </div>
                    ...
                    <button
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="text-slate-600 text-xs sm:text-sm mt-1 leading-relaxed">
                                    Professional IDE for full-featured Saveltedevelopment
                                </p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-3 ml-4 flex-shrink-0">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h5 class="font-medium text-slate-800 text-sm sm:text-base">Quick Setup</h5>
                                    <p class="text-slate-600 text-xs sm:text-sm mt-1 leading-relaxed">
                                        File → New → Project → Select "SavelteWeb App" template
                                    </p>
                                </div>
                            </div>
                            <div class="flex items-start">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-slate-600 text-xs sm:text-sm mt-1 leading-relaxed">
                                        Run: <code
                                            class="bg-slate-100 text-slate-800 px-2 py-1 rounded text-xs font-mono">dotnet new Savelte-o BlazorApp</code>
                                    </p>
                                </div>
                            </div>
                            <div class="flex items-start">
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-gray-600 text-xs sm:text-sm mt-1">
                            ...
                            <br>Select <strong>SavelteWeb App</strong> template
                        </p>
                    </div>
                </div>
                <div class="flex items-start">
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-gray-600 text-xs sm:text-sm mt-1">Click <strong>New Project</strong> → Select
                            <strong>SavelteWeb App</strong> template
                        </p>
                    </div>
                </div>
                <div class="flex items-start">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="mt-3 space-y-3">
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <p class="text-gray-600 text-xs sm:text-sm font-medium mb-2"><strong>SavelteWeb
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <p class="text-gray-600 text-xs sm:text-sm font-medium mb-2"><strong>SavelteServer:</strong>
            ...
            <div class="flex items-start bg-blue-50 rounded-lg p-3 sm:p-4">
                ...
                <div class="ml-3 flex-1 min-w-0">
                    ...
                    <p class="text-gray-600 text-xs sm:text-sm">
                        For customizing the Editflo Savelteintegration:
                        <br><br>
                        • <a href="#" class="text-blue-600 hover:underline font-medium">Editflo Basic Setup</a>
                        <br>• <a href="#" class="text-blue-600 hover:underline font-medium">Editflo SavelteTechnical
                            Reference</a>
                    </p>
                </div>
            </div>
...
<script>
import Editor from '@Editflo/Editflo-svelte';
let conf = {
  height: 500,
  menubar: false,
  plugins: [
