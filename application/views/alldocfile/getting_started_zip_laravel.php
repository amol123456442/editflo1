<main class="mx-auto min-h-screen px-3 sm:px-4 md:px-6 lg:px-4">
    ...
    <header class="text-start">
        <div class="flex items-center mb-3 sm:mb-4 md:mb-5">
            <h2 class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800">Using editflo with Laravel Framework</h2>
        </div>
        <p class="text-gray-600 text-sm sm:text-base mt-1 sm:mt-2">
            Laravel is a scalable web application framework built on PHP. This guide assists with adding editflo from the editflo .zip package to pages or views in Laravel.
        </p>
    </header>
    ...
    <section class="bg-white rounded-lg sm:rounded-xl shadow-md p-4 sm:p-6 mb-8 mt-3">
        ...
        <div class="flex flex-col sm:flex-row items-start mb-8 p-4 bg-gray-50 rounded-lg">
            <div class="flex-1 min-w-0">
                <h3 class="font-semibold text-gray-800 mb-3 text-sm sm:text-base">Download and Extract editflo</h3>
                <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-xs sm:text-sm leading-6">
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center space-x-2">
                            <div class="w-2 h-2 bg-red-500 rounded-full"></div>
                    ...
                    <div class="space-y-2">
                        <code class="block text-blue-400"># Download editflo and extract to resources/js directory</code>
                        <code class="block text-green-400">unzip ../editflo_latest.zip -d resources/js</code>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-xs sm:text-sm leading-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <code class="block text-gray-300">('resources/js/editflo/js/editflo', 'public/js/editflo');</code>
                    </div>
                </div>
        ...
        <div class="flex flex-col sm:flex-row items-start mb-8 p-4 bg-gray-50 rounded-lg">
            <div class="flex-1 min-w-0">
                ...
                <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-xs sm:text-sm leading-6 max-h-72 overflow-y-auto">
                    ...
                    <div class="space-y-1">
                        <code class="block"><span class="text-blue-400">&lt;script</span> <span class="text-purple-400">src</span>=<span class="text-yellow-400">"{{ asset('js/editflo/editflo.min.js') }}"</span> <span class="text-purple-400">referrerpolicy</span>=<span class="text-yellow-400">"origin"</span> <span class="text-purple-400">crossorigin</span>=<span class="text-yellow-400">"anonymous"</span><span class="text-blue-400">&gt;&lt;/script&gt;</span></code>
                        <code class="block"><span class="text-blue-400">&lt;script&gt;</span></code>
                        <code class="block ml-4"><span class="text-green-400">editflo.init</span>({</code>
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="bg-gray-100 p-3 rounded text-xs sm:text-sm mb-4">
                    <code class="block font-mono">
                        <span class="text-purple-600">php artisan make:component Forms/editfloEditor</span>
                    </code>
                </div>
                <p class="text-gray-600 text-sm mb-3">
                    File:
                    <code class="bg-gray-200 px-2 py-1 rounded text-xs">
                        resources/views/components/forms/editflo-editor.blade.php
                    </code>
                </p>
                <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-xs sm:text-sm leading-6">
                    <div class="flex items-center justify-between mb-3">
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-xs sm:text-sm leading-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <code class="block text-gray-300 ml-8"><span class="text-blue-400">&lt;title&gt;</span>editflo in Laravel<span class="text-blue-400">&lt;/title&gt;</span></code>
                        <code class="block text-gray-300 ml-8"><span class="text-green-400">&lt;!-- Insert the blade containing the editflo configuration and source script --&gt;</span></code>
                        <code class="block text-gray-300 ml-8"><span class="text-blue-400">&lt;x-head.editflo-config/&gt;</span></code>
                        <code class="block text-gray-300 ml-4"><span class="text-blue-400">&lt;/head&gt;</span></code>
                        <code class="block text-gray-300 ml-4"><span class="text-blue-400">&lt;body&gt;</span></code>
                        <code class="block text-gray-300 ml-8"><span class="text-blue-400">&lt;h1&gt;</span>editflo in Laravel<span class="text-blue-400">&lt;/h1&gt;</span></code>
                        <code class="block text-gray-300 ml-8"><span class="text-green-400">&lt;!-- Insert the blade containing the editflo placeholder HTML element --&gt;</span></code>
                        <code class="block text-gray-300 ml-8"><span class="text-blue-400">&lt;x-forms.editflo-editor/&gt;</span></code>
                        <code class="block text-gray-300 ml-4"><span class="text-blue-400">&lt;/body&gt;</span></code>
    ...
    <div class="bg-blue-50 rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <h4 class="font-semibold text-gray-700 mb-4">editflo Configuration</h4>
                <ul class="space-y-3 text-sm">
                    ...
                    <li class="flex items-start">
                        <span class="text-blue-500 mr-3 mt-0.5 flex-shrink-0">→</span>
                        <a href="#" class="text-gray-700 hover:text-blue-600 hover:underline">Customizing editflo</a>
                    </li>
                    <li class="flex items-start">
                        <span class="text-blue-500 mr-3 mt-0.5 flex-shrink-0">→</span>
                    ...
                    <li class="flex items-start">
                        <span class="text-blue-500 mr-3 mt-0.5 flex-shrink-0">→</span>
                        <a href="#" class="text-gray-700 hover:text-blue-600 hover:underline">Localizing editflo</a>
                    </li>
                </ul>
            </div>
            <div>
