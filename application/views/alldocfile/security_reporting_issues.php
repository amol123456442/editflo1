<div class="mx-auto min-h-screen">
    ...
    <div class="mb-8">
        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 p-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-blue-700 sm:text-base">
        ...
        <div class="space-y-4">
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <p class="text-gray-700 text-sm sm:text-base text-sm sm:text-base">How to report potential security vulnerabilities in Editflo.</p>
                </div>
            </div>
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <p class="text-gray-700 text-sm sm:text-base text-sm sm:text-base">Our security practices including scripts and XSS vulnerabilities, and keeping dependencies up-to-date.</p>
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <p class="text-gray-700 text-sm sm:text-base text-sm sm:text-base">Recommendations for configuring HTTP Strict Transport Security.</p>
                </div>
            </div>
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <p class="text-gray-700 text-sm sm:text-base text-sm sm:text-base">How to configure CSP headers that work with Editflo.</p>
                </div>
            </div>
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <p class="text-gray-700 text-sm sm:text-base text-sm sm:text-base">Security risks including Cross-Site Scripting (XSS), Injection, and other vulnerabilities.</p>
    ...
    <div id="what-we-do-to-maintain-security-for-editflo" class="bg-white rounded-lg border border-gray-200 p-6 mb-8 scroll-mt-6">
        ...
        <ul class="list-disc list-inside text-gray-700 text-sm sm:text-base text-sm sm:text-base mb-4 space-y-2 ml-4">
    ...
    <div id="enforcing-https-with-hsts" class="bg-white rounded-lg border border-gray-200 p-6 mb-8 scroll-mt-6">
        ...
        <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <p class="text-gray-700 text-sm sm:text-base text-sm sm:text-base mb-2">For comprehensive guidance on implementing HSTS, refer to the following resources:</p>
            <ul class="list-disc list-inside text-gray-700 text-sm sm:text-base space-y-1 ml-4">
    ...
    <div id="configuring-content-security-policy-for-editflo" class="bg-white rounded-lg border border-gray-200 p-6 mb-8 scroll-mt-6">
        ...
        <div class="space-y-6">
            <div>
                ...
                <p class="text-gray-700 text-sm sm:text-base mb-3">Use this CSP header:</p>
            ...
            <div>
                ...
                <p class="text-gray-700 text-sm sm:text-base mb-3">Use this CSP header (excludes the *.editflo.cloud domain):</p>
                <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                    <span class="text-blue-400">&lt;meta</span><br>
                    <span class="text-gray-300 ml-4"></span><span class="text-green-400">http-equiv=</span><span class="text-yellow-300">"Content-Security-Policy"</span><br>
    ...
    <div id="general-security-risks-for-user-input-elements" class="bg-white rounded-lg border border-gray-200 p-6 mb-8 scroll-mt-6">
        ...
        <div id="sanitizing-html-input-to-protect-against-xss-attacks" class="mb-8 scroll-mt-6">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-700 text-sm sm:text-base mb-2">Input string:</p>
                ...
                <p class="text-gray-700 text-sm sm:text-base mb-2">After DOMParser correction:</p>
            ...
            <div class="mb-8">
                ...
                <div class="space-y-2 mb-4">
                    <div class="flex items-center">
                        <span class="text-gray-700 text-sm sm:text-base mr-3">Type:</span>
                        <span class="bg-gray-100 px-2 py-1 rounded text-sm font-medium">Boolean</span>
                    </div>
                    <div class="flex items-center">
                        <span class="text-gray-700 text-sm sm:text-base mr-3">Default value:</span>
                        <span class="bg-green-100 text-green-800 px-2 py-1 rounded text-sm font-medium">true</span>
                    </div>
                    <div class="flex items-center">
                        <span class="text-gray-700 text-sm sm:text-base mr-3">Possible values:</span>
                ...
                <div class="mb-4">
                    <p class="text-gray-700 text-sm sm:text-base mb-2">Example: using xss_sanitization to turn DOMPurify off</p>
                    <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
            ...
            <div class="mb-8">
                <h4 class="text-md font-medium text-gray-800 mb-3 sm:text-base">Securing embedded external resources</h4>

                <!-- sandbox_iframes option -->
                <div class="mb-6">
                    <h5 class="text-sm font-medium text-gray-800 mb-2 sm:text-base">sandbox_iframes option</h5>
                    <p class="text-gray-700 text-sm sm:text-base mb-3">
                    ...
                    <div class="mb-4">
                        <p class="text-gray-700 text-sm sm:text-base mb-2">Example: using sandbox_iframes option</p>
                        <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                            <span class="text-purple-400">editflo</span><span class="text-gray-300">.</span><span class="text-yellow-300">init</span><span class="text-gray-300">({</span><br>
                            <span class="text-gray-300 ml-4"></span><span class="text-blue-400">selector</span><span class="text-gray-300">: </span><span class="text-green-400">'textarea'</span><span class="text-gray-300">, </span><span class="text-green-400">// change this value according to your HTML</span><br>
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        <p class="text-gray-700 text-sm sm:text-base mb-2">Example: using convert_unsafe_embeds option</p>
                        <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                            <span class="text-purple-400">editflo</span><span class="text-gray-300">.</span><span class="text-yellow-300">init</span><span class="text-gray-300">({</span><br>
                            <span class="text-gray-300 ml-4"></span><span class="text-blue-400">selector</span><span class="text-gray-300">: </span><span class="text-green-400">'textarea'</span><span class="text-gray-300">, </span><span class="text-green-400">// change this value according to your HTML</span><br>
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        <p class="text-gray-700 text-sm sm:text-base mb-2">Example: using allow_html_in_comments</p>
                        <div class="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                            <span class="text-purple-400">editflo</span><span class="text-gray-300">.</span><span class="text-yellow-300">init</span><span class="text-gray-300">({</span><br>
