<div class="mx-auto min-h-screen px-4">
    ...
    <p class="p-2 text-gray-700 text-sm sm:text-base">This demo shows an example form using Bootstrap together with editflo and the editflo Bootstrap skin and Bootstrap icon pack. It’s designed to closely match the colors, forms, and buttons of the default Bootstrap framework UI.
