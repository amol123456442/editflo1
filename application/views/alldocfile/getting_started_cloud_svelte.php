<main class="mx-auto min-h-screen px-3 sm:px-4 md:px-6 lg:px-4 ">
    ...
    <header class="text-start">
        <div class="flex items-center mb-3 sm:mb-4 md:mb-5">
            <h2 class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800">Using Editflo from the Tiny Cloud CDN with the Svelte framework</h2>
        </div>
        ...
        <p class="text-gray-600 text-sm sm:text-base mt-1 sm:mt-2 flex items-start">
            For examples of the Editflo Svelte integration, visit the Editflo-svelte storybook.
        </p>
    </header>
        ...
        <div class="space-y-3 sm:space-y-4">
            ...
            <div class="flex items-start">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-600 text-xs sm:text-sm mt-1">Create a new Svelte project named Editflo-svelte-demo.</p>
                    <code class="bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs sm:text-sm mt-1 sm:mt-2 inline-block font-mono">npm create svelte@latest Editflo-svelte-demo</code>
                </div>
            </div>
            ...
            <div class="flex items-start">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <code class="bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs sm:text-sm mt-1 sm:mt-2 inline-block font-mono">cd Editflo-svelte-demo</code>
            ...
            <div class="flex items-start">
                ...
                <div class="flex-1 min-w-0">
                    <h3 class="font-medium text-gray-800 text-sm sm:text-base">Install Editflo Svelte</h3>
                    <p class="text-gray-600 text-xs sm:text-sm mt-1">Install the Editflo Svelte package in your project.</p>
                    <code class="bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs sm:text-sm mt-1 sm:mt-2 inline-block font-mono">npm install @editflo/editflo-svelte</code>
                </div>
            </div>
            ...
            <div class="flex items-start">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-gray-600 text-xs sm:text-sm mt-1 mb-3 sm:mb-5">Using a text editor, open /path/to/Editflo-svelte-demo/src/App.svelte and replace the contents with:</p>
                    ...
                    <div class="bg-gray-900 text-gray-100 p-3 sm:p-4 md:p-6 rounded-lg font-mono text-xs sm:text-sm overflow-x-auto border border-gray-700">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-purple-400">import</span> <span class="text-gray-300">{ onMount } </span>
                                <span class="text-purple-400">from</span> <span class="text-green-400">'svelte'</span><span class="text-gray-300">;</span>
                            </div>
                            <div class="flex">
                                ...
                                <span class="text-purple-400">from</span> <span class="text-green-400">'@editflo/editflo-svelte'</span><span class="text-gray-300">;</span>
                            </div>
                            <div class="flex">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300 ml-6 sm:ml-12"></span>
                                <span class="text-yellow-300">console</span><span class="text-gray-300">.</span><span class="text-yellow-300">log</span><span class="text-gray-300">(editorRef.</span><span class="text-yellow-300">getContent</span><span class="text-gray-300">());</span>
                            </div>
                            <div class="flex">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300">&lt;</span><span class="text-yellow-300">main</span><span class="text-gray-300">&gt;</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-6 sm:w-8 text-right pr-2 sm:pr-4 text-xs">30</span>
                                <span class="text-gray-300 ml-2 sm:ml-4"></span>
                                <span class="text-gray-300">&lt;</span><span class="text-yellow-300">h1</span><span class="text-gray-300">&gt;Editflo Svelte Demo&lt;/</span><span class="text-yellow-300">h1</span><span class="text-gray-300">&gt;</span>
                            </div>
                            <div class="flex">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300 ml-4 sm:ml-8"></span>
                                <span class="text-blue-400">apiKey</span><span class="text-gray-300">=</span><span class="text-green-400">"no-api-key"</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-6 sm:w-8 text-right pr-2 sm:pr-4 text-xs">33</span>
                                <span class="text-gray-300 ml-4 sm:ml-8"></span>
                                <span class="text-blue-400">bind:editor</span><span class="text-gray-300">=</span><span class="text-purple-400">{</span><span class="text-gray-300">editorRef</span><span class="text-purple-400">}</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-6 sm:w-8 text-right pr-2 sm:pr-4 text-xs">34</span>
                                <span class="text-gray-300 ml-4 sm:ml-8"></span>
                                <span class="text-blue-400">initialValue</span><span class="text-gray-300">=</span><span class="text-green-400">"&lt;p&gt;This is the initial content of the editor.&lt;/p&gt;"</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-6 sm:w-8 text-right pr-2 sm:pr-4 text-xs">35</span>
                                <span class="text-gray-300 ml-4 sm:ml-8"></span>
                                <span class="text-blue-400">init</span><span class="text-gray-300">=</span><span class="text-purple-400">{</span><span class="text-gray-300">init</span><span class="text-purple-400">}</span>
                            </div>
                            <div class="flex">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300 ml-2 sm:ml-4"></span>
                                <span class="text-gray-300">&lt;</span><span class="text-yellow-300">button</span> <span class="text-blue-400">on:click</span><span class="text-gray-300">=</span><span class="text-purple-400">{</span><span class="text-gray-300">log</span><span class="text-purple-400">}</span><span class="text-gray-300">&gt;</span>
                            </div>
                            <div class="flex">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300 ml-2 sm:ml-4"></span>
                                <span class="text-gray-300">&lt;/</span><span class="text-yellow-300">button</span><span class="text-gray-300">&gt;</span>
                            </div>
                            <div class="flex">
                    ...
                    <p class="text-gray-600 text-xs sm:text-sm mt-2 sm:mt-3 flex items-start">
                        ...
                        This Svelte component will create an application containing a Editflo editor configured with basic features.
                    </p>
                </div>
            </div>
            ...
            <div class="flex items-start">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="mt-1 sm:mt-2 space-y-1 sm:space-y-2">
                        <p class="text-gray-600 text-xs sm:text-sm">To start the development server, navigate to the <code class="bg-gray-100 px-1 rounded text-xs">Editflo-svelte-demo</code> directory and run:</p>
        ...
        <div class="border-t border-gray-200 pt-4 sm:pt-6 mt-4 sm:mt-6">
            ...
            <div class="space-y-2 sm:space-y-3">
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-gray-600 text-xs sm:text-sm">Copy contents of <code class="bg-gray-100 px-1 rounded text-xs">Editflo-svelte-demo/dist</code> to web server root.</p>
                    </div>
                </div>
            </div>
