<div class="mx-auto min-h-screen px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 mb-6 sm:mb-8">
        <h2 class="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">General examples</h2>
        <p class="text-gray-700 mb-3 sm:mb-4 text-sm sm:text-base">This table sets out the Editflo general working examples included in the Editflo documentation.</p>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 mb-6 sm:mb-8">
        <h2 class="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">Integration examples</h2>
        <p class="text-gray-700 mb-3 sm:mb-4 text-sm sm:text-base">This table sets out Editflo use-case–specific basic working examples included in the Editflo documentation.</p>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 mb-6 sm:mb-8">
        <h2 class="text-xl sm:text-2xl font-semibold text-gray-800 mb-3 sm:mb-4">Skins and Icons examples</h2>
        <p class="text-gray-700 mb-3 sm:mb-4 text-sm sm:text-base">This table sets out Editflo's range of pre-made skins and icon packs included in the Editflo documentation.</p>

        <!-- Skins and Icons Grid -->
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <!-- Bootstrap Demo -->
            <div class="border border-gray-200 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow">
